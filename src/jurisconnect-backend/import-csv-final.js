...
async function importCsvFinal() {
    // No global transaction to allow partial imports
    try {
        ...
        for (const [index, row] of records.entries()) {
            ...
            try {
                ...
                // 1. Generate Protocol (Unique)
                // Using timestamp + index to guarantee uniqueness
                ...
                await Demanda.create({
                    ...
                    tipo_demanda: tipo || 'diligencia', // Use actual type from CSV
                    status,
                    prioridade: 'media',
